...
(function(){
    ...
    momo.config = {
        wikiurl: momourl||"http://kaiyuan.hudong.com",
        areaid: momoid,
        keylength: momolength||16,
        selecttype: momotype||1,
        setarea: function(){
       		momo.config.area = document.getElementById(this.keylength)||document
       	},
        ...
        '<input type = "checkbox" onclick = "momo.disable();"/>' +
        '<a href = "#" onclick = "momo.disable();">关闭互动摸摸功能</a>' +
        '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' +
    ...
    momo.e({
        disable: function() {
                document.cookie="disablemomo=true";
                switch(momo.config.selecttype){
        		case '0':
	        		momo.event.stop();
	        		momo.tag.init();
    ...
    {
       c_start=document.cookie.indexOf("disablemomo=");
       if (c_start == -1)
       {
