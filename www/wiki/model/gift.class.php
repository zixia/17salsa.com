...
class giftmodel {
	...
	/*修改礼品*/
	function edit($id,$title, $credit, $description=''){
		$this->db->query("UPDATE ".DB_TABLEPRE."gift SET title = '$title',credit='$credit', description ='$description', time = '".$this->base->time."'  WHERE id = ".$id);
	}
