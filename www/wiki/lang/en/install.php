...
$lang['step2PHPVersionTooLowTip'] = '您的PHP版本低于4.0.6, 无法使用HDWiki';
...
$lang['step3DBConfigWriteErrorTip'] = '安装程序无法写入系统核心配置文件, 请修改配置文件./config/config.inc.php权限！';
$lang['step3DBConfigNotWriteTip'] = './config.inc.php文件不可写，请修改为可写！';
...
$lang['step3MySqlHostComment'] = 'MySQL数据库服务器地址, 一般为 localhost';
