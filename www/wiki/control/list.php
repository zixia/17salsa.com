...
class control extends base{
	...
	function dorss(){
		if($this->get[2]){
			...
			echo "<link>".$this->setting['site_url']."/".$this->setting['seo_prefix']."list-".$this->get[2]."</link>\n";
			echo "<description>".$typename."</description>\n";
			echo "<generator>".$this->setting['site_url']."</generator>\n";
			...
			if (is_array($doclist)){
				...
				echo"<link>".$this->setting['site_url']."/".$this->setting['seo_prefix']."doc-view-".$doc['did']."</link>\n";
