...
$_SC['dbname'] 	= '17salsa';						//SupeSite数据库名

$_SC['tablepre'] = 'supe_';					//SupeSite表名前缀(不能与论坛的表名前缀相同)
$_SC['pconnect'] = 0;						//SupeSite数据库持久连接 0=关闭, 1=打开
$_SC['dbcharset'] = 'utf8';					//SupeSite数据库字符集

$_SC['siteurl'] = 'https://17salsa.com/site';						//SupeSite程序文件所在目录的URL访问地址。可以填写以 http:// 开头的完整URL，也可以填写相对URL。末尾不要加 /。如果程序无法自动获取，请务必手工修改为 http://www.yourwebsite.com/supesite 形式
...
//--------------- UCenter HOME设置 ---------------
$_SC['dbhost_uch'] 	= getenv('SALSA17_MYSQL_HOST');				//UCenter HOME数据库服务器
$_SC['dbuser_uch'] 	= getenv('SALSA17_MYSQL_USER');					//UCenter HOME数据库用户名
$_SC['dbpw_uch'] 	= getenv('SALSA17_MYSQL_PASS');						//UCenter HOME数据库密码
$_SC['dbname_uch'] 	= '17salsa';					//UCenter HOME数据库名
...
$_SC['uchurl'] = 'https://17salsa.com/home';						//UCenter HOME URL地址。可以填写以http://开头的完整URL，也可以填写相对URL。末尾不要加 /
...
//安全相关
$_SC['founder'] = '1,37';						//创始人 UID, 可以支持多个创始人，之间使用 “,” 分隔。部分管理功能只有创始人才可操作。
...
//--------------- 邮件发送配置 ---------------
$_SC['adminemail'] = 'salsa@17salsa.org';			//系统Email
...
// 通信相关
define('UC_KEY', '51Td10Vb5cs9F6Ict7gdMdvdWdk02eq6VfG3dfedu4r6R5K0v8E1oadbldp8n6h9');	// 与 UCenter 的通信密钥, 要与 UCenter 保持一致
