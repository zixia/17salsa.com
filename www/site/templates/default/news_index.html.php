...
<div class="column">
	<div class="col1">
		...
		<!--最新资讯-->
		<!--{block name="spacenews" parameter="type/news/grade/1/catid/3,4,6,8/order/i.dateline DESC/limit/0,9/cachetime/85400/subjectlen/40/subjectdot/0/cachename/newnews1"}-->
	...
	<div class="col2">
        ...
        <div class="global_module margin_bot10 bg_fff"><!--magzine -->
