...
<div id="wrap">
<div id="header">
<h2><a href="<?=S_URL?>/" title="<?=$_SCONFIG['sitename']?>"><img src="admin/images/loginlogo.gif" alt="<?=$_SCONFIG['sitename']?>" /></a></h2>
...
<?php } ?>
<a href="javascript:history.back();">返回上一页</a> &nbsp; <a href="<?=S_URL?>/">首页</a>
</div>
