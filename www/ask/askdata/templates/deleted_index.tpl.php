...
<div class="t3 bcg"><div class="t3t bgg"><a href="<?php echo $web_path;?>browse.php?type=7" class="lbk">知识分享</a></div></div>
<div id="solve" class="b3 bcg mb12 qlist">
<?php if(is_array($knowledge_sharing)) { foreach($knowledge_sharing as $ql) { ?>
...
<?php } } ?>
<div class="lmore"><a href="<?php echo $web_path;?>browse.php?type=7" class="lmore">更多&gt&gt</a></div>
</div>
