...
<a href="<?php echo $web_path;?>member.php?uid=<?php echo $members['uid'];?>" target="_blank"><img src="<?php echo $members['avatar'];?>" width="48" height="48" border="0" /></a>
<br /><a href="<?php echo $web_path;?>member.php?uid=<?php echo $members['uid'];?>" target="_blank"><?php echo $members['username'];?></a>
</td>
