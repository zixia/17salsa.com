...
document.onclick = function(e){
	...
	//弹出层的二次操作禁止关闭
	try{
		if(fInObj(el, "createUrl") || fInObj(el, "createImg") || fInObj(el, "createSwf")||fInObj(el, "createMp3")){
			return;
		}
	}catch(e){}
	fHideMenu();
...
function fHideMenu(){
	try{
		var arr = ["fontface", "fontsize", "dvForeColor", "dvPortrait", "divAlign", "divList" ,"divInOut", "editFaceBox", "createUrl", "createImg", "createSwf","createMp3"];
