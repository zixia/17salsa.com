...
a.icoMp3{background-position:-577px 1px}
...
<a href="javascript:;" class="icoMp3" id="icoMp3" onClick="createMp3(event, 0);return false;" title="插入MP3"></a>
...
<div id="createMp3" class="eMenu" style="display:none;top:35px;left:26px;width:400px;font-size:12px">请输入MP3音乐URL地址:<br/>
