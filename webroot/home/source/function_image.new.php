...
/*
	if ( '222.131.185.197' == $_SERVER['REMOTE_ADDR'] )
	{
		error_log("makewaatermark TESTING");
		return makewatermark_imagemagic($srcfile);
	}
*/
    ...
    switch($src_info[2]) {
        case 1:@imagegif($src_im, $srcfile, 90);break;
        case 2:@imagejpeg($src_im, $srcfile, 90);break;
        case 3:@imagepng($src_im, $srcfile, 90);break;
        default:return '';
    }
...
function makewatermark_imagemagic($srcfile) {
	...
	MagickSetImageCompressionQuality($photo_res, 92);
	if( !MagickWriteImage($photo_res, $file_output) )
	{
