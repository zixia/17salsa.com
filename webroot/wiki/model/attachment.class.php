...
class attachmentmodel {
	...
	function insert_image_js($images,$link=''){
		...
		echo '</head>';
		echo '<body>';
		echo '<script type="text/javascript">parent.HD.plugin["image"].insert("'.$images.'","'.$link.'");</script>';
		echo '</body>';
		echo '</html>';
	}
	...
	function showmsg($msg){
		...
		echo '<script type="text/javascript">alert(document.getElementById("msg").value);parent.HD.plugin["image"].error();</script>';
		echo '</body>';
		echo '</html>';
	}
