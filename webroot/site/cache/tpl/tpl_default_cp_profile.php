...
<tr><td>创建时间</td>
<td><?php sdate('Y-m-d',$_SGLOBAL[member][dateline]); ?></td></tr>
<tr><td>上次登录</td>
<td>
<?php if(($_SGLOBAL['timestamp'] - $_SGLOBAL['member']['lastlogin']) > 86400) { ?>
 <?php sdate("Y-m-d", $value[updatetime]); ?>
<?php } else { ?>
<?php echo intval(($_SGLOBAL['timestamp'] - $_SGLOBAL['member']['lastlogin']) / 3600 + 1);; ?>小时之前
<?php } ?>
</td></tr>
<tr><td>最后更新</td>
<td><?php sdate('Y-m-d',$_SGLOBAL[member][updatetime]); ?></td></tr>
</tbody></table>
</div>
</div>
<?php } elseif($op=='avatar') { ?>
<div class="global_module margin_bot10 bg_fff userpanel">
